...
const Karachi = () => {
    ...
    useEffect(() => {
        const fetchCourses = async () => {
            setIsLoading(true);
            try {
                const response = await axios.get(`https://www.admin777.pny-trainings.com/api/shortcourse/short-courses-in-karachi`);
    ...
    return (
        <>
            ...
            <section className='lg:h-[254px] bg-[#152438;] text-white flex flex-col justify-center items-center max-sm:p-5'>
                <div className='text-[48px] max-sm:text-[24px] font-semibold'>Karachi</div>
