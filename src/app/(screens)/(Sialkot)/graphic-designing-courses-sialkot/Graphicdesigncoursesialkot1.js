...
const Graphicdesigncoursesialkot1 = () => {
    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin777.pny-trainings.com/api/city/specialpage/${'graphic-designing-courses-sialkot'}`
        );
...
export default Graphicdesigncoursesialkot1;
