    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin777.pny-trainings.com/api/city/specialpage/${'amazon-dropshipping-training-course-in-lahore-pakistan'}`
        );
...
export default Amazondropshipping1;
