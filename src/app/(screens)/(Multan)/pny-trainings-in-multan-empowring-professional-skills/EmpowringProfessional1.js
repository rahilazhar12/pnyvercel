    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin777.pny-trainings.com/api/city/specialpage/${'pny-trainings-in-multan-empowring-professional-skills'}`
        );
...
export default EmpowringProfessional1;
