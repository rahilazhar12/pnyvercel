    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin777.pny-trainings.com/api/city/specialpage/${'amazon-virtual-assistant-course-in-islamabad'}`
        );
...
export default Amazonvirtualassistant1;
