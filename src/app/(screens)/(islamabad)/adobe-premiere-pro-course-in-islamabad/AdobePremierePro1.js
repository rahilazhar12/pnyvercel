    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin777.pny-trainings.com/api/city/specialpage/${'adobe-premiere-pro-course-in-islamabad'}`
        );
...
export default AdobePremierePro1;
