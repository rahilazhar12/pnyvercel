import Socialmediamarketing1 from "./Socialmediamarketing1";

export default async function Socialmediamarketing() {
  const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/social-media-marketing-course-in-islamabad')
